...
import { ArrowRight, QrCode, BarChart3, Shield, Zap, Star, Users, Clock, LogOut } from 'lucide-react';
        ...
        <Container>
          <HeroContent>
            ...
            >
              ...
              >
                <Text $size="xl" $mb="2.5rem" $color="#57534e" style={{ maxWidth: '600px', margin: '0 auto 2.5rem' }}>
              ...
              >
                <Flex $justify="center" $gap="1rem" style={{ marginBottom: '2rem', flexWrap: 'wrap' }}>
                  <Link href="/auth/signin">
                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  ...
                  <Link href="/qr-test">
                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                      <Button $size="lg" $variant="outline" style={{ background: 'white', color: '#ed7734', borderColor: '#ed7734' }}>
