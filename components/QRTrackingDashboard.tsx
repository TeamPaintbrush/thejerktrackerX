...
export default function QRTrackingDashboard() {
  ...
  const navigationItems = [
    { id: 'dashboard', label: 'Dashboard', icon: <Home size={20} />, href: '/admin' },
    { id: 'orders', label: 'Orders', icon: <Package size={20} />, href: '/admin' },
    { id: 'create', label: 'Create Order', icon: <PlusCircle size={20} />, href: '/order' },
    { id: 'menu', label: 'Menu Items', icon: <Menu size={20} />, href: '/admin' },
    { id: 'qr', label: 'QR Codes', icon: <QrCodeIcon size={20} />, href: '/qr-tracking' },
          ...
          <NavContainer>
            <NavLeft>
              <Logo href="/">
                ...
                <div>
                  <LogoTitle>TheJERKTracker</LogoTitle>
                  <LogoSubtitle>QR Tracking</LogoSubtitle>
                </div>
              </Logo>
              <NavMenu>
                <NavList>
    ...
    <PageContainer>
      ...
      <ContentWrapper>
        <div style={{ fontSize: '0.875rem', color: '#6b7280', marginBottom: '1rem' }}>
          Manage orders and track pickups
        </div>
